        ...
        if str(option) in selected_options:
            ...
            try:
                ...
                # Option 5: Related Queries
                    ...
                    try:
                        delay_and_retry(lambda: pytrends.build_payload(kw_list=[search], timeframe='now 1-d'))#<------here you can change the days accorging to you prefrence for example just                   